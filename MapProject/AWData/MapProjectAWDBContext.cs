...
namespace MapProject.AWData
{
    public partial class MapProjectAWDBContext : DbContext
    {
        public MapProjectAWDBContext()
        {
        }

        public MapProjectAWDBContext(DbContextOptions<MapProjectAWDBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:mapproject.database.windows.net,1433;Initial Catalog=MapProjectAWDB;Persist Security Info=False;User ID=mapproject;Password=Password1!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
            }
        }
